...
if choose == "Machine Learning":
    ...
    if selected_sub_area == "Text Summarization":
        with col2:
            input_article_dd = st.selectbox("Example inputs", ('<select>',
                                                               'The Bharat Jodo Yatra went from south to north but it has had a countrywide effect, Congress leader Rahul Gandhi said on Sunday, asserting the march have an alternative vision to the country. Speaking at a press conference after the march ended with the hoisting of the tricolour at the Lal Chowk here, Gandhi said he got to learn and understand a lot during the over 4,000-km journey. He also said he would think about whether a west to east yatra can be undertaken in future.',
                                                               ), key=10)
    ...
    if selected_sub_area == "Keywords extractor":
        with col1:
            selected_ner = col1.radio("Select problem", ('Generic', 'Resume', 'Medical'))
        if selected_ner == "Resume":
            with col2:
                input_article_dd = st.selectbox("Example inputs", ('<select>',
                                                                   "Rahul Mahajan Application Development Associate - Accenture  Bengaluru, Karnataka - Email me on Indeed: indeed.com/r/Abhishek-Jha/10e7a8cb732bc43a  • To work for an organization that provides me the opportunity to improve my skills and knowledge for my individual and company's growth in best possible ways.  Willing to relocate to: Bangalore, Karnataka  WORK EXPERIENCE  Application Development Associate  Accenture -  November 2017 to Present  Role: Currently working on Chatbot. Developing Backend Oracle PeopleSoft Queries for the Bot which will be triggered based on a given input. Also, Train the bot for different possible utterances (Both positive and negative), which will be given as input by the user.  EDUCATION  B.E in Information science and engineering  B.v.b college of engineering and technology -  Hubli, Karnataka  August 2013 to June 2017  12th in Mathematics  Woodbine modern school  April 2011 to March 2013  10th  Kendriya Vidyalaya  April 2001 to March 2011  SKILLS  C (Less than 1 year), Database (Less than 1 year), Database Management (Less than 1 year), Database Management System (Less than 1 year), Java (Less than 1 year)  ADDITIONAL INFORMATION  Technical Skills  https://www.indeed.com/r/Abhishek-Jha/10e7a8cb732bc43a?isid=rex-download&ikw=download-top&co=IN   • Programming language: C, C++, Java • Oracle PeopleSoft • Internet Of Things • Machine Learning • Database Management System • Computer Networks • Operating System worked on: Linux, Windows, Mac  Non - Technical Skills  • Honest and Hard-Working • Tolerant and Flexible to Different Situations • Polite and Calm • Team-Player",
    ...
    if input_article_dd != '<select>':
        input_article = col2.text_area("Enter text for prediction (English language only)", input_article_dd)
    else:
